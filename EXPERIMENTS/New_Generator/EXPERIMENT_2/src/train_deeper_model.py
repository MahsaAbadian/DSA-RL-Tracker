...
def run_unified_training(run_dir, base_seed=BASE_SEED, clean_previous=False, experiment_name=None, resume_from=None, curve_config_path=None):
    ...
    for stage in stages:
        ...
        # Save current stage config for future anti-forgetting
        full_stage_cfg = stage['curve_generation'].copy()
        full_stage_cfg.update(stage['training'])
        previous_stages.append((full_stage_cfg, stage['name']))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--curve_config", type=str)
    parser.add_argument("--resume_from", type=str)
    parser.add_argument("--clean_previous", action="store_true")
    parser.add_argument("--experiment_name", type=str)
    args = parser.parse_args()
    
    run_unified_training(args.run_dir, args.base_seed, args.clean_previous, args.experiment_name, args.resume_from, args.curve_config)