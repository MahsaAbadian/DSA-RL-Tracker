...
from src.models import DecoupledStopActorOnly
...
def main():
    ...
    # 2. Load Decoupled ActorOnly model
    K = 8
    model = DecoupledStopActorOnly(n_movement_actions=N_MOVEMENT_ACTIONS, K=K).to(DEVICE)
